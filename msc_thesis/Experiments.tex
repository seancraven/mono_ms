...
\subsection{Catch}
To demonstrate that the method extends to other environments, with different group actions the equivariant actor-critic is implemented for the Bsuite Catch environment.
